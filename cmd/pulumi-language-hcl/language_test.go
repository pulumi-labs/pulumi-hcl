...
var expectedFailures = map[string]string{
	...
	"l2-invoke-output-only":                        "not yet implemented",
	"l2-invoke-scalar":                             "not yet implemented",
	"l2-invoke-scalars":                            "not yet implemented",
	...
	"l2-large-string":                              "not yet implemented",
	...
	"l2-plain":                                     "not yet implemented",
	"l2-primitive-ref":                             "not yet implemented",
