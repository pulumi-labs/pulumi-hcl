...
var expectedFailures = map[string]string{
	...
	"l1-output-bool":                               "program generation not yet implemented",
	"l1-output-map":                                "program generation not yet implemented",
	"l1-output-null":                               "program generation not yet implemented",
	"l1-output-number":                             "program generation not yet implemented",
	"l1-output-string":                             "program generation not yet implemented",
