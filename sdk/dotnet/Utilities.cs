...
namespace Pulumi.Labs.Hcl
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pulumi-labs/pulumi-hcl";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Labs.Hcl.version.txt");
    ...
    internal sealed class HclResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public HclResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
